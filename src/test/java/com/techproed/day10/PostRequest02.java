...
olduğunu test edin
    ...
    public void test() {
        ...
        Response response = given().contentType(ContentType.JSON).
                ...
                //requestbody JSONOBjekt ile olusturulmussa toString
                        body(requestBodyJSONObject.toString()).when().
                        post("/{parametre1}");
        ...
        Assert.assertEquals(requestBodyJSONObject.getJSONObject("bookingdates").
                getString("checkin"), ((Map) ((Map<?, ?>) actualDataMap.
                get("booking")).
                get("bookingdates")).get("checkin"));

         Assert.assertEquals(requestBodyJSONObject.
                        getJSONObject("bookingdates").getString("checkout"),
                ((Map)((Map)actualDataMap.get("booking")).
